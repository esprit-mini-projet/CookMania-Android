package tn.duoes.esprit.cookmania.views.corned_beef;
...
public abstract class CoachMark {
    ...
    public abstract static class CoachMarkBuilder {
        ...
        /**
         * Set an {@link OnDismissListener} to be called when the
         * coach mark is dismissed
         * 
        ...
        /**
         * Set an {@link OnTimeoutListener} to be called when the
        ...
        /**
         * Set an {@link OnShowListener} to be called when the
         * coach mark is shown
         * 
         * @param listener
         */
